  ...
  return (
    <header
      className={cn(
        ...
        scrolled ? "bg-white/90 backdrop-blur-md border-b border-sand-200/70 shadow-[0_4px_24px_-12px_rgba(22,36,53,0.18)]" : "bg-white/80 backdrop-blur-md border-b border-white/20"
      )}
    >
